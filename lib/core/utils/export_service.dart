...
class ExportService {
  ...
  // ═══════════════════════════════════════════════
  // SAVE WITH PICKER (User pilih lokasi)
  // ═══════════════════════════════════════════════
// ═══════════════════════════════════════════════
// SHARE FILE (ganti saveWithPicker)
// ═══════════════════════════════════════════════
  Future<ExportResult> shareFile({
...
// ═══════════════════════════════════════════════
// SAVE TO DOWNLOADS (tanpa picker)
// ═══════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════
  // GENERATE EXCEL BYTES (tanpa save)
  // ═══════════════════════════════════════════════
  Uint8List? generateExcelBytes({
    ...
    final excel = _buildExcelDocument(
      date: date,
      summary: summary,
      bestSellers: bestSellers,
      transactions: transactions,
          ...
          if (transactions.isEmpty)
            ...
            pw.Table(
              ...
              children: [
                ...
                ...transactions.map((trx) {
                  final time =
                      DateFormat('HH:mm').format(DateTime.parse(trx.createdAt));
                  return _pdfTableRow([
                    trx.invoiceNumber,
                    time,
                    trx.paymentLabel ?? trx.paymentMethod,
  ...
  // ═══════════════════════════════════════════════
  // BUILD EXCEL DOCUMENT (reusable)
  // ═══════════════════════════════════════════════
  xl.Excel _buildExcelDocument({
    required DateTime date,
    required Map<String, dynamic> summary,
    required List<Map<String, dynamic>> bestSellers,
    required List<TransactionsTableData> transactions,
    ...
    // Sheet: Produk Terlaris
    final s2 = excel['Produk Terlaris'];
    s2.appendRow([
      xl.TextCellValue('No'),
      xl.TextCellValue('Produk'),
      xl.TextCellValue('Qty'),
